...
class LinkDAO extends DAO 
{
     ...
     *
     * @return \DocBoard\Domain\Link|throws an exception if no matching link is found
     */
     ...
     *
     * @param \DocBoard\Domain\Comment $link The link to save
     */
