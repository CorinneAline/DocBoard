...
{
    /**
     * @var \DocBoard\DAO\ArticleDAO
     */
    private $articleDAO;

    /**
     * @var \DocBoard\DAO\UserDAO
     */
    private $userDAO;
     ...
     * @return \DocBoard\Domain\Comment
     */
     ...
     * @param \DocBoard\Domain\Comment $comment The comment to save
     ...
     * @return \DocBoard\Domain\Comment|throws an exception if no matching comment is found
