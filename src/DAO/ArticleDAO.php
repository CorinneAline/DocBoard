...
class ArticleDAO extends DAO
{
     ...
     *
     * @param \DocBoard\Domain\Article $article The article to save
     */
     ...
     * @param integer $id The article id.
     *
     * @return \DocBoard\Domain\Article|throws an exception if no matching article is found
     */
     ...
     * @return \DocBoard\Domain\Article
     */
