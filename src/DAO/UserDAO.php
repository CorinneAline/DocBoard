...

{
     ...
     * @return \DocBoard\Domain\User|throws an exception if no matching user is found
...

    {
        ...
        return 'DocBoard\Domain\User' === $class;
     ...
     * @param \DocBoard\Domain\User $user The user to save
